  ...
  function exportdata($table,$title,$desc,$namafile,$folderpath='')
    {
        ...
        // $result = $CI->db->query("select nis,nama,jurusan,tpoin from user where nis between '".$nawal."' and '".$nakhir."' order by nis asc");
        $result = $CI->db->query("select nis,nama,jurusan,tpoin from user order by nis asc");
