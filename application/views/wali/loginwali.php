                ...
                <div class="pages">
                    ...
                    <div class="login">
                      <div class="login-box animated fadeInUp">
                          <form  method="post" class="login-form" action="<?php echo base_url(); ?>wali/log" name="login">

                            <center><h2>BUKU SAKU SMK TELKOM<br>PURWOKERTO</h2>
                            <div id="logo"><img src="<?php echo base_url(); ?>assets/images/logo.png"></div><br><br>
                            <h3 style="line-height:1.3em">ANDA MASUK SEBAGAI<BR> WALI MURID</h3></center><br>
                              <p class="login-box-msg"  class="uppercase"><?php echo $info; ?></p>
                            
                            <input  type="text" name="nis" id="nis" placeholder="Nomer Induk Siswa" onblur="cek()" class="login-input"/ required>
                            <button id="masuk" class="ph-button ph-btn-grey" type="submit">MASUK</button>
                            <br /><br /><a style="color:white; text-align:right;"href="<?php echo base_url(); ?>">masuk sebagai Siswa</a>
