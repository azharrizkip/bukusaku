              ...
              <div class="home">
                <div class="login">
                  <div class="login-box animated fadeInUp">
                    ...
                    <form style="" method="post" class="login-form" id="gantips" action="<?php echo base_url(); ?>siswa/kirim" onsubmit="return validasi_input(this)">
                      <center><h2>Isi Data Diri Anda</h2><br><br>
                        ...
                        <input  type="text" name="nis"  value="<?php echo $nis; ?>" readonly="yes" class="login-input"/>
                        <input  type="text" name="nama" value="<?php echo $nama; ?>" readonly="yes" class="login-input"/>
